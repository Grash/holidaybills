...
angular.module('angularcarousel', [
    'ngTouch'
]);
                ...
                compile: function (tElement, tAttributes) {
                    ...
                    return function (scope, iElement, iAttributes, containerCtrl) {
                            ...
                            if (angular.isFunction(indexModel.assign)) {
                                ...
                                scope.$parent.$watch(indexModel, function (newValue, oldValue) {
                                    if (newValue !== undefined) {
                                        ...
                                        if ( slidesCount>0&&(newValue > slidesCount- tAttributes['rncarouselmorecallindex'])) {
                                            if (tAttributes['rncarouselmore'] != null) {

                                               var paginateFn=$parse(tAttributes['rncarouselmore']);
                                               paginateFn(scope, {item:scope.item});
                                              //  scope.$eval(tAttributes['rncarouselmore']);
                        ...
                        function updateContainerWidth() {
                            ...
                            if (container.parent().hasClass('carouselContainer')) {
                                container.css('width', Math.min(getCarouselWidth() * 4, 1024) + 'px');
                            }
                            else if (container.parent().hasClass('topic-list-item-slider')) {
                                container.css('width', Math.max((getCarouselWidth() + 15) * 6, 1024) + 'px');
                            }
                            else {
                                container.css('width', getCarouselWidth() + 'px');
                            }
